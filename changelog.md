...
## registry.buildpiper.in/s3-uploader-step

| Image Tag       | Features                                                                                   | Fixes                | Improvements                                                                                   | Notes                                                                                            |
| --------- | ------------------------------------------------------------------------------------------ | -------------------- | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
...
| Image Tag       | Features                                                         | Fixes                | Improvements                                  | Notes             |
| --------- | ---------------------------------------------------------------- | -------------------- | --------------------------------------------- | ----------------- |
|   solv-0.0.1 | - Base image: `amazon/aws-cli`.                                  | None in this release | - Initial version with basic S3 upload logic. | - Uses root user. |
|           | - Installed `jq`.                                                |                      |                                               |                   |
